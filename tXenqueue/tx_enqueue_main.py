...
def job_receiver():
    ...
    if response_ok_flag:
        ...
        our_queue.enqueue('webhook.job', our_response_dict, job_timeout=JOB_TIMEOUT, job_id="tx_"+our_job_id, result_ttl=(60*60*3)) # A function named webhook.job will be called by the worker
