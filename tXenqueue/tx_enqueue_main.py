...
def job_receiver():
    ...
    if response_ok_flag:
        ...
        our_queue.enqueue('webhook.job', our_response_dict, job_timeout=JOB_TIMEOUT, job_id=our_job_id, result_ttl=(60*60*24)) # A function named webhook.job will be called by the worker
